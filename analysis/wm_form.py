...
from wm_tipps.role_experiment import normalize_manual_results  # noqa: E402
...
def main() -> int:
    ...
    # T-0180: manual_results.json erlaubt die Kurzform {"ga-001": [1, 0]} NEBEN
    # dem vollen Dict {"actual":..,"penalty_winner":..,"shootout":..}
    # (siehe role_experiment.normalize_manual_results). Rohes r["actual"]
    # bricht bei der Kurzform mit TypeError -- deshalb ueber die gemeinsame
    # Normalisierung lesen statt selbst zu unterscheiden.
    res = normalize_manual_results(json.loads((DATA_DIR / "manual_results.json").read_text()))
