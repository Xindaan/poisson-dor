...
def build_dashboard_payload() -> dict[str, Any]:
    ...
    # T-0188: eine Quelle fuer Ergebnisse (Fixtures + manuelles Override,
    # inklusive Elfmeter-Sieger und -bilanz) statt einer dritten Kopie hier.
    live_results = played_results(fixture_rows)
